...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext{
    ...
    /// 源VC
    CMHExampleViewController *fromVC = (CMHExampleViewController *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    
    /// 目标VC
    CMHDiscoverViewController *toVC = (CMHDiscoverViewController *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag{
    ...
    /// 源VC
    CMHExampleViewController *fromVC = (CMHExampleViewController *)[self.transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    
    /// 目标VC
    CMHDiscoverViewController *toVC = (CMHDiscoverViewController *)[self.transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
