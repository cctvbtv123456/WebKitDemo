...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext{
    ...
    /// 获取来源控制器
    CMHDiscoverViewController * fromVC = (CMHDiscoverViewController *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    /// 获取目的控制器
    CMHExampleViewController *toVC = (CMHExampleViewController *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
...
- (void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag{
    ...
    /// 获取来源控制器
    CMHDiscoverViewController *fromVC = (CMHDiscoverViewController *)[self.transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
